 ...
 const handleOpenModal = (userId) => {
  ...
  const handleAddSector = async () => {
    try {
      ...
      const response = await axios.post('https://ai-pm-internship-backend.onrender.com/api/sectors', { name }); // Adjust based on your actual data structure
  ...
  const handleUpdateSector = async () => {
    try {
      const response = await axios.put(`https://ai-pm-internship-backend.onrender.com/api/sectors/${editingUserId}`, {name}); // Adjust endpoint as necessary
  ...
  const handleDeleteSector = async (userId) => {
    if (window.confirm("Are you sure you want to delete this Sector?")) {
      try {
        const response = await axios.delete(`https://ai-pm-internship-backend.onrender.com/api/sectors/${userId}`); // Adjust endpoint as necessary
        toast.success(response.data.message);
