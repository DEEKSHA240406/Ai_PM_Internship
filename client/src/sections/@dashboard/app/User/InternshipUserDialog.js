    ...
    const handleUpdateInternship = async () => {
        try {
            ...
            const response = await axios.put(
                `https://ai-pm-internship-backend.onrender.com/api/internships/admin/internships/${internshipId}`,
                dataToSubmit,
    ...
    return (
        <Dialog open={open} onClose={onClose} fullWidth maxWidth="md">
            ...
            <DialogContent>
                ...
                {/* Skills Section */}
                <Typography variant="h6" sx={{ mt: 2, mb: 1 }}>Skills Required</Typography>
                ...
                <Typography variant="h6" sx={{ mt: 2, mb: 1 }}>Sectors</Typography>
                {loadingSectors ? (
                    ...
                    <Autocomplete
                        ...
                        renderInput={(params) => (
                            <TextField
                                ...
                                helperText="Select from predefined PM Internship sectors"
                            />
                        )}
                ...
                <Box sx={{ display: 'flex', gap: 1, mb: 1 }}>
                    <TextField
                        ...
                        size="small"
                    />
                    <Button onClick={addEducation} variant="outlined">Add</Button>
                </Box>
                <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 1, mb: 2 }}>
